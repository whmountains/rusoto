...
impl AttributeDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = Attribute::default(); // needs deserializer: xmlpayloadparser
...
impl DomainMetadataResultDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = DomainMetadataResult::default(); // needs deserializer: xmlpayloadparser
...
impl GetAttributesResultDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = GetAttributesResult::default(); // needs deserializer: xmlpayloadparser
...
impl ItemDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = Item::default(); // needs deserializer: xmlpayloadparser
...
impl ListDomainsResultDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = ListDomainsResult::default(); // needs deserializer: xmlpayloadparser
...
impl SelectResultDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = SelectResult::default(); // needs deserializer: xmlpayloadparser
