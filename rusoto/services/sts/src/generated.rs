...
impl AssumeRoleResponseDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = AssumeRoleResponse::default(); // needs deserializer: xmlpayloadparser
...
impl AssumeRoleWithSAMLResponseDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = AssumeRoleWithSAMLResponse::default(); // needs deserializer: xmlpayloadparser
...
impl AssumeRoleWithWebIdentityResponseDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>
        ...
        let mut obj = AssumeRoleWithWebIdentityResponse::default(); // needs deserializer: xmlpayloadparser
...
impl AssumedRoleUserDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = AssumedRoleUser::default(); // needs deserializer: xmlpayloadparser
...
impl CredentialsDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = Credentials::default(); // needs deserializer: xmlpayloadparser
...
impl DecodeAuthorizationMessageResponseDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>
        ...
        let mut obj = DecodeAuthorizationMessageResponse::default(); // needs deserializer: xmlpayloadparser
...
impl FederatedUserDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = FederatedUser::default(); // needs deserializer: xmlpayloadparser
...
impl GetCallerIdentityResponseDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = GetCallerIdentityResponse::default(); // needs deserializer: xmlpayloadparser
...
impl GetFederationTokenResponseDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = GetFederationTokenResponse::default(); // needs deserializer: xmlpayloadparser
...
impl GetSessionTokenResponseDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = GetSessionTokenResponse::default(); // needs deserializer: xmlpayloadparser
