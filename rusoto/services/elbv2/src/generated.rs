...
impl ActionDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = Action::default(); // needs deserializer: xmlpayloadparser
...
impl CertificateDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = Certificate::default(); // needs deserializer: xmlpayloadparser
...
impl CipherDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = Cipher::default(); // needs deserializer: xmlpayloadparser
...
impl CreateListenerOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = CreateListenerOutput::default(); // needs deserializer: xmlpayloadparser
...
impl CreateLoadBalancerOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = CreateLoadBalancerOutput::default(); // needs deserializer: xmlpayloadparser
...
impl CreateRuleOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = CreateRuleOutput::default(); // needs deserializer: xmlpayloadparser
...
impl CreateTargetGroupOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = CreateTargetGroupOutput::default(); // needs deserializer: xmlpayloadparser
...
impl DeleteListenerOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let obj = DeleteListenerOutput::default(); // no deserializer needed: xmlpayloadparser
...
impl DeleteLoadBalancerOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let obj = DeleteLoadBalancerOutput::default(); // no deserializer needed: xmlpayloadparser
...
impl DeleteRuleOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let obj = DeleteRuleOutput::default(); // no deserializer needed: xmlpayloadparser
...
impl DeleteTargetGroupOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let obj = DeleteTargetGroupOutput::default(); // no deserializer needed: xmlpayloadparser
...
impl DeregisterTargetsOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let obj = DeregisterTargetsOutput::default(); // no deserializer needed: xmlpayloadparser
...
impl DescribeListenersOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = DescribeListenersOutput::default(); // needs deserializer: xmlpayloadparser
...
impl DescribeLoadBalancersOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = DescribeLoadBalancersOutput::default(); // needs deserializer: xmlpayloadparser
...
impl DescribeRulesOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = DescribeRulesOutput::default(); // needs deserializer: xmlpayloadparser
...
impl DescribeSSLPoliciesOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = DescribeSSLPoliciesOutput::default(); // needs deserializer: xmlpayloadparser
...
impl DescribeTargetGroupAttributesOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>
        ...
        let mut obj = DescribeTargetGroupAttributesOutput::default(); // needs deserializer: xmlpayloadparser
...
impl DescribeTargetGroupsOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = DescribeTargetGroupsOutput::default(); // needs deserializer: xmlpayloadparser
...
impl DescribeTargetHealthOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = DescribeTargetHealthOutput::default(); // needs deserializer: xmlpayloadparser
...
impl LoadBalancerAttributeDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = LoadBalancerAttribute::default(); // needs deserializer: xmlpayloadparser
...
impl MatcherDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = Matcher::default(); // needs deserializer: xmlpayloadparser
...
impl ModifyListenerOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = ModifyListenerOutput::default(); // needs deserializer: xmlpayloadparser
...
impl ModifyRuleOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = ModifyRuleOutput::default(); // needs deserializer: xmlpayloadparser
...
impl ModifyTargetGroupAttributesOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>
        ...
        let mut obj = ModifyTargetGroupAttributesOutput::default(); // needs deserializer: xmlpayloadparser
...
impl ModifyTargetGroupOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = ModifyTargetGroupOutput::default(); // needs deserializer: xmlpayloadparser
...
impl RegisterTargetsOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let obj = RegisterTargetsOutput::default(); // no deserializer needed: xmlpayloadparser
...
impl RuleConditionDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = RuleCondition::default(); // needs deserializer: xmlpayloadparser
...
impl SetRulePrioritiesOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = SetRulePrioritiesOutput::default(); // needs deserializer: xmlpayloadparser
...
impl SetSecurityGroupsOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = SetSecurityGroupsOutput::default(); // needs deserializer: xmlpayloadparser
...
impl SetSubnetsOutputDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = SetSubnetsOutput::default(); // needs deserializer: xmlpayloadparser
...
impl SslPolicyDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = SslPolicy::default(); // needs deserializer: xmlpayloadparser
...
impl TargetDescriptionDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = TargetDescription::default(); // needs deserializer: xmlpayloadparser
...
impl TargetGroupDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = TargetGroup::default(); // needs deserializer: xmlpayloadparser
...
impl TargetGroupAttributeDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = TargetGroupAttribute::default(); // needs deserializer: xmlpayloadparser
...
impl TargetHealthDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = TargetHealth::default(); // needs deserializer: xmlpayloadparser
...
impl TargetHealthDescriptionDeserializer {
    ...
    fn deserialize<'a, T: Peek + Next>(tag_name: &str,
        ...
        let mut obj = TargetHealthDescription::default(); // needs deserializer: xmlpayloadparser
